            ...
            <div class="bg-white space-y-12">
                ...
                <div class="ml-10 mr-10 border-b border-gray-900/10 pb-12">
                    ...
                    <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        ...
                        <div class="sm:col-span-4">
                            <label class="block text-sm font-medium leading-6 text-gray-900">Inscrições até:</label>
                            <div class="mt-2">
                                <input id="termina_em" name="termina_em" type="date" autocomplete="date"
                                    class="block w-7/12 rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="sm:col-span-2">
                        <div class="mt-4 col-span-full">
                            <label class="block text-sm font-medium leading-6 text-gray-900">Sobre a vaga</label>
                            <div class="mt-2">
                                <textarea id="descricaoVaga" name="descricaoVaga"
